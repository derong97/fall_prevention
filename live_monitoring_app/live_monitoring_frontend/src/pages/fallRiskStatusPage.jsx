...
class readyPage extends Component {
  ...
  componentDidMount(){
    this.interval = setInterval(() => {
      ...
      this.setState({ fallRiskStatus: fall_risk_status,
                      timeElapsedSeconds: (newTimeElapsedSeconds<10)?("0"+newTimeElapsedSeconds): newTimeElapsedSeconds})
      }
      , 1000);
  }
    ...
    return (
      ...
      <View style = {styles.statusBar}>
        ...
        <View>
          ...
          <Text style = {styles.textTimeElapsed}>{this.state.timeElapsedMinutes} : {this.state.timeElapsedSeconds}</Text>
        </View>
