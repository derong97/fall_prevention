...
def get_predicted_label_first(sit_score, bend_score, stand_score, tampered_score, inaction_score, w_bl, w_br, w_fl, w_fr):
    w_b_sum = w_bl + w_br
    w_f_sum = w_fl + w_fr
    ...
    if sit_probability > max(bend_probability, stand_probability, tampered_probability, inaction_probability):
      ...
      predicted_label = 1
    previous_state_w_b = w_b_change
    previous_state_w_f = w_f_change
...
get_predicted_label_first(0,-21.328,-22.827,-25.596,-20,1.39,14.08,8.58,418.46)
