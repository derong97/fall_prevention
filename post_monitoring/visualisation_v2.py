...
def app():
    ...
    with hfr_count: 
        ...
        st.write("The average number of times the patient has triggered the High Fall Risk alert (i.e. by getting up/ standing) over all their unaccompanied toilet visits. For example, a patient records 3 unaccompanied toilet visits, and activates the High Fall Risk alarm 2 times. The HFR Count ratio is 2/3 = 0.66 .")
    ...
    with frequency: 
        ...
        st.write("The average number of toilet visits of all currently registered patients during that hour over the last 7 days. For example, 21 toilet visits was recorded at 0900 over the past week. Average frequency is 21/7 = 3.")
    ...
    with average_visits: 
        ...
        st.write("The average number of times a patient visits the toilet for every day that a toilet visit is recorded. For example, the patient visited the toilet 5 and 8 times on day 1 and 6 respectively (with no toilet visits from day 2 to 5), the daily average number is (8+5)/2 = 6.5.")
